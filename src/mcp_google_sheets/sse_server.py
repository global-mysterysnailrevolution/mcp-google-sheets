...
def main():
    ...
    logger.info("Starting Google Sheets MCP Server with SSE transport")
    
    # Create the MCP server
    server = create_server()
    
    # Configure and start the server with SSE transport
    logger.info("Starting MCP server on 0.0.0.0:8000 with SSE transport")
    logger.info("Server will be accessible at: https://your-domain/sse/")
